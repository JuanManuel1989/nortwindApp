		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products of Northwind",
									"targetURL": "#ProductsofNorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProductsofNorthwind-display": {
								"semanticObject": "ProductsofNorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwind.products.northwindapp",
									"url": sap.ui.require.toUrl("northwind/products/northwindapp")
								}
							}
						}
					}
